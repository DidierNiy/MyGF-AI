        ...
        try {
            ...
            if (smartResult.success && smartResult.data.length > 0) {
                ...
                return {
                    ...
                    role: Role.MODEL,
                    text: smartResult.message || `Great news! I found ${smartResult.data.length} properties that match your needs with ${smartResult.confidence}% confidence! 🎉`,
            ...
            console.log('Smart search not available, falling back to AI matching:', smartSearchError);
            // Fall through to AI-based matching
        }
