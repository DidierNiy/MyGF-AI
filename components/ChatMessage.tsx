...
const PropertyCard: React.FC<{ 
    ...
    <div className="flex-shrink-0 w-80 bg-white dark:bg-gray-800/50 rounded-xl shadow-lg overflow-hidden snap-center border border-gray-200 dark:border-transparent flex flex-col">
        {/* Image section */}
              ...
              {hasProperties && (
                  <div className="relative">
                      <div 
                          ...
                          className="flex gap-4 overflow-x-auto pb-4 px-4 pt-2 snap-x snap-mandatory scrollbar-hide"
                      >
                      ...
                      {canScrollLeft && (
                          <button 
                              ...
                              className="absolute left-2 top-1/2 -translate-y-1/2 z-10 p-1 bg-white/80 dark:bg-black/70 backdrop-blur-sm rounded-full shadow-md hover:bg-white dark:hover:bg-black transition-all"
                      ...
                      {canScrollRight && (
                          <button 
                              ...
                              className="absolute right-2 top-1/2 -translate-y-1/2 z-10 p-1 bg-white/80 dark:bg-black/70 backdrop-blur-sm rounded-full shadow-md hover:bg-white dark:hover:bg-black transition-all"
